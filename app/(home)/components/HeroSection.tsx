...
A Shopify 360 developer with professional experience in Shopify theme development, Klaviyo integration, Meta advertising tools, and custom feature implementations.        </p>
      ...
      <div className="relative">
        <div className="w-72 h-72 space-y-3 rotate-[60deg] py-10 relative ">
          <div className="flex gap-3 translate-x-8 ">
            ...
            <div className="w-32 h-32 rounded-3xl bg-gray-500 rotate-45 hover:rotate-90 transition-all"></div>
          </div>
          <div className="flex gap-3 -translate-x-8 ">
            <div className="w-32 h-32 rounded-3xl bg-gray-500 rotate-45 hover:rotate-90 transition-all"></div>
